...
<header class="sticky top-0 z-10 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur">
    <div class="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-5 py-4">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('school-forms.home') }}" class="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-bold text-slate-700">Back</a>
            <a href="{{ route('school-forms.f137.download', ['student' => $student->student_number ?: $student->lrn]) }}" class="rounded-lg bg-blue-600 px-5 py-2 text-sm font-bold text-white">Download F137 Excel</a>
        </div>
    </div>
</header>
