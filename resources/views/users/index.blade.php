    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form method="GET" action="{{ route('users.index') }}" class="flex flex-col gap-3 sm:flex-row sm:items-end">
            <div class="flex-1">
                ...
                <p class="mt-1 text-xs text-slate-500">Search securely by email address, student number, or name. This tool is available only to administrators.</p>
                <input id="account-search" name="search" type="search" value="{{ $search }}" maxlength="255"
                    placeholder="student@gmail.com or 2026-0001"
